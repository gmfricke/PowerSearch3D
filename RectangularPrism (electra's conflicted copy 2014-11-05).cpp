    ...
    Coordinate new_vect, previous_vector;
        ...
        for (int i = 0; i < n_searchers; i++ )
        {
            ...
            case 0:
                ...
                return;
                break;
            case 1: scale = getFromNormalPDF()*time_resolution;
                //cout << "RectangularPrism:updateSearcherPositions: Brownian" << endl;
                break;
            case 2: scale = getFromLogNormalPDF()*time_resolution;
            ...
            case 4: scale = getFromPowerLawPDF()*time_resolution;//1.0, 70, -2.15)*time_resolution;
                ...
                scale *= 0.4104; //1.64179;//0.021; // Make mean equal to observed mean speed of 0.11
                //cout << scale << endl;
                break;
            case 5: scale = getFromExponentialPDF()*time_resolution;
                ...
                break;
            case 6:
                scale = getFromGammaPDF(1.5914, 0.0730)*time_resolution;
