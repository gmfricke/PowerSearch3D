...
public:
  ...
  QRect axisSelection() const { return mAxisSelectionBox; }
...
class QCP_LIB_DECL QCPStatisticalBox : public QCPAbstractPlottable
{
  ...
  Q_PROPERTY(QPen meanPen READ meanPen WRITE setMeanPen)
  Q_PROPERTY(QCPScatterStyle outlierStyle READ outlierStyle WRITE setOutlierStyle)
  Q_PROPERTY(QCPScatterStyle meanStyle READ meanStyle WRITE setMeanStyle)
  /// \endcond
public:
  ...
  QPen meanPen() const { return mMeanPen; }
  QCPScatterStyle outlierStyle() const { return mOutlierStyle; }
  QCPScatterStyle meanStyle() const { return mMeanStyle; }
  ...
  void setMeanPen(const QPen &pen);

  void setOutlierStyle(const QCPScatterStyle &style);
  void setMeanStyle(const QCPScatterStyle &style);
...
protected:
  ...
  double mKey, mMinimum, mLowerQuartile, mMedian, mUpperQuartile, mMaximum, mMean;
  double mWidth;
  double mWhiskerWidth;
  QPen mWhiskerPen, mWhiskerBarPen, mMedianPen, mMeanPen;
  QCPScatterStyle mOutlierStyle, mMeanStyle;
  ...
  virtual void drawMean(QCPPainter *painter) const;
